...
.border-\\[\\#0029af\\] {
  --tw-border-opacity: 1;
  border-color: rgb(0 41 175 / var(--tw-border-opacity));
}
.border-gray-200 {
  --tw-border-opacity: 1;
...
.text-\\[\\#0029af\\] {
  --tw-text-opacity: 1;
  color: rgb(0 41 175 / var(--tw-text-opacity));
}
.text-\\[\\#50d71e\\] {
  --tw-text-opacity: 1;
...
.hover\\:text-\\[\\#0842ff\\]:hover {
  --tw-text-opacity: 1;
  color: rgb(8 66 255 / var(--tw-text-opacity));
}
