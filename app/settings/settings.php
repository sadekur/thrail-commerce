<div class="p-6">
    ...
    <div id="settings-form" class="hidden p-6 bg-white shadow rounded-lg">
        <form id="commerce-kit-settings-form">
                ...
                <tbody>
                    <tr class="border-b">
                        ...
                        <td class="py-4 px-2">
                            ...
                            <p class="text-sm text-gray-500 mt-1"><?php esc_html_e( 'Enable to display donation on the cart page.', 'commerce-kit' ); ?></p>
                            <p class="text-sm text-gray-500">
                                <strong><?php esc_html_e( 'Note: ', 'commerce-kit' ); ?></strong><?php esc_html_e( 'When using WooCommerce blocks on the cart page, use the Woo donations block. For more details ', 'commerce-kit' ); ?><a href="https://youtube.com" target="_blank" class="text-blue-600 underline"><?php esc_html_e( 'watch the video', 'commerce-kit' ); ?></a>.
                            </p>
                        </td>
                    </tr>
                    <tr class="border-b">
                    ...
                    <tr class="border-b">
                        ...
                        <td class="py-4 px-2">
                            ...
                            <p class="text-sm text-gray-500 mt-1"><?php esc_html_e( 'Enable to display donation note.', 'commerce-kit' ); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr class="border-b">
                        <th class="py-4 px-2 font-medium"><?php esc_html_e('Button Text Color', 'commerce-kit'); ?></th>
                        <td class="py-4 px-2">
                            ...
                            <p class="text-sm text-gray-500 mt-1"><?php esc_html_e('Select donation button text color.', 'commerce-kit'); ?></p>
                        </td>
                    </tr>
                </tbody>
            </table>
