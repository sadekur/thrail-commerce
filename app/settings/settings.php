        ...
        <form id="thrail-commerce-settings-form">
            <table class="w-full text-left">
                <tbody>
                    ...
                    <tr class="border-b">
                        <th class="py-4 px-2 font-medium"><?php esc_html_e('Donation Note', 'thrail-commerce'); ?></th>
                        <td class="py-4 px-2">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" class="sr-only peer" name="tcwt_note" value="on" <?php checked($tcwt_note, 'on'); ?>>
                                <div class="w-11 h-6 bg-gray-200 rounded-full peer-focus:ring-4 peer-focus:ring-blue-300 peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                            </label>
                            <p class="text-sm text-gray-500 mt-1"><?php esc_html_e('Enable to display donation note.', 'thrail-commerce'); ?></p>
                        </td>
                    </tr>

                    <tr class="border-b">
                        <th class="py-4 px-2 font-medium"><?php esc_html_e('Button Color', 'thrail-commerce'); ?></th>
                        <td class="py-4 px-2">
                            ...
                            <p class="text-sm text-gray-500 mt-1"><?php esc_html_e('Select donation button color.', 'thrail-commerce'); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="py-4 px-2">
                            ...
                            <p class="text-sm text-gray-500 mt-1"><?php esc_html_e('Enter donation button text.', 'thrail-commerce'); ?></p>
                        </td>
                    </tr>

                    <tr class="border-b">
                        <th class="py-4 px-2 font-medium"><?php esc_html_e('Button Text Color', 'thrail-commerce'); ?></th>
                        <td class="py-4 px-2">
                            ...
                            <p class="text-sm text-gray-500 mt-1"><?php esc_html_e('Select donation button text color.', 'thrail-commerce'); ?></p>
                        </td>
                    </tr>
                </tbody>
            </table>
            <button type="submit" class="mt-6 bg-blue-600 text-white py-2 px-4 rounded-lg shadow hover:bg-blue-700"><?php esc_html_e('Save Settings', 'thrail-commerce'); ?></button>
        </form>
    </div>
</div>