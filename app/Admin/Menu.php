            ...
            <div class="p-6">
                ...
                <div class="p-6 bg-white shadow rounded-lg">
                    <form id="thrail-commerce-settings-form">
                        <table class="w-full text-left">
                            <tbody>
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="py-4 px-2">
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" class="sr-only peer" name="tcwt_cart" value="on">
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="py-4 px-2">
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" class="sr-only peer" name="tcwt_checkout" value="on">
                                            <div class="w-11 h-6 bg-gray-200 rounded-full peer-focus:ring-4 peer-focus:ring-blue-300 peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                                        </label>
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="py-4 px-2">
                                        <label class="relative inline-flex items-center cursor-pointer">
                                            <input type="checkbox" class="sr-only peer" name="tcwt_note" value="on">
                                            <div class="w-11 h-6 bg-gray-200 rounded-full peer-focus:ring-4 peer-focus:ring-blue-300 peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                                        </label>
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="py-4 px-2">
                                        <input type="color" name="tcwt_btncolor" class="w-10 h-10 p-1 rounded border border-gray-300 cursor-pointer" value="#289dcc">
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="py-4 px-2">
                                        <input type="text" name="tcwt_btntext" class="w-4/12 border border-gray-300 p-2 rounded" value="Add Donation">
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="py-4 px-2">
                                        <input type="color" name="tcwt_textcolor" class="w-10 h-10 p-1 rounded border border-gray-300 cursor-pointer" value="#FFFFFF">
                        ...
                        <!-- Submit Button -->
                        <input type="hidden" name="tcwt_wpnonce" value="<?php echo wp_create_nonce('thrail_commerce_tip_nonce'); ?>">
