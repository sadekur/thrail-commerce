    ...
    <div class="p-6 bg-white shadow rounded-lg">
        <table class="w-full text-left">
            <tbody>
                <!-- Cart Page Toggle -->
                <tr class="border-b">
                    <th class="py-4 px-2 font-medium">Add on Cart Page</th>
                    <td class="py-4 px-2">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Enable to display donation on cart page.</p>
                        <p class="text-sm text-gray-500">
                            <strong>Note: </strong>When using WooCommerce blocks on the cart page, use the Woo donations block. 
                            For more details <a href="https://youtu.be/t9JjLhYcu54" target="_blank" class="text-blue-600 underline">watch the video</a>.
                        </p>
                    </td>
                </tr>
                ...
                <tr class="border-b">
                    <th class="py-4 px-2 font-medium">Add on Checkout Page</th>
                    <td class="py-4 px-2">
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" class="sr-only peer" name="wdgk_checkout" value="on">
                            <div class="w-11 h-6 bg-gray-200 rounded-full peer-focus:ring-4 peer-focus:ring-blue-300 peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                        </label>
                        <p class="text-sm text-gray-500 mt-1">Enable to display donation on the checkout page.</p>
                        <p class="text-sm text-gray-500">
                            <strong>Note: </strong>When using WooCommerce blocks on the checkout page, use the Woo donations block. 
                            For more details <a href="https://youtu.be/t9JjLhYcu54" target="_blank" class="text-blue-600 underline">watch the video</a>.
                        </p>
                    </td>
                </tr>
